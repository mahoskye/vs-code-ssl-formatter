...
export interface ParametersStatementNode extends ASTNode {
    kind: ASTNodeType.ParametersStatement /* parameters: IdentifierListNode; */;
}
export interface DeclareStatementNode extends ASTNode {
    kind: ASTNodeType.DeclareStatement /* identifiers: IdentifierListNode; */;
}
export interface DefaultStatementNode extends ASTNode {
    kind: ASTNodeType.DefaultStatement /* defaults: DefaultParameterListNode; */;
}
export interface PublicStatementNode extends ASTNode {
    kind: ASTNodeType.PublicStatement /* identifiers: IdentifierListNode; */;
}
export interface IncludeStatementNode extends ASTNode {
    kind: ASTNodeType.IncludeStatement /* path: StringLiteralNode; */;
}
